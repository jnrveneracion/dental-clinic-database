...
<body>
<h1 class="modal-title fs-8 text-center" id="exampleModalLabel" style="width: -webkit-fill-available;">Add Patient's Treatment</h1>
        ...
        <div class="header">
          ...
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" id="myform">
              <div class="input-group mb-3">
                  ...
                  <select name="Patient_ID" class="form-select" aria-label="Default select example" id="PatientIDA">
                  </select>
                  <script>
                      document.getElementById("PatientIDA").innerHTML = "<?php include('forms/viewRecorded.php') ?> <?php echo $dropdown; ?>";
                  </script>
              </div>
              <div class="input-group mb-3">
                  <div class="input-group-prepend">
              ...
              <div class="input-group mb-3">
                  ...
                  <script>
                      document.getElementById("dentista").innerHTML = "<?php include('forms/viewRecordedDentist.php') ?> <?php echo $dropdown; ?>";
                  </script>
              </div>
              <div class="input-group mb-3">
                  <div class="input-group-prepend">
