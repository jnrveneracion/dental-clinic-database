...
<body>
<div class="container-xxl bg-white rounded shadow p-3 mb-5 bg-body-tertiary rounded-7" id="Appointments" style="width: -webkit-fit-content;">
  <h1 class="text-center">Patients Records</h1>
  <hr>
    <div class="form-group bg-white" style="width: -webkit-fill-available; float: left; padding: 11px; width: -webkit-fit-content; border-radius: 0px 10px 10px 0px;" id='appSticky'>
        ...
        <span class="dot bg-dark-subtle"></span> <span class="Count" id='kid' style="font-weight: bold;"> </span> - Kid / Teenager 
        <span class="dot bg-dark-subtle"></span> <span class="Count" id='adult' style="font-weight: bold;"> </span> - Adult 
        <span class="dot bg-dark-subtle"></span> <span class="Count" id='senior' style="font-weight: bold;"> </span> - Senior 
    </div>
    ...
    <tbody class="table-group-divider">
      <?php
        ...
        if ($result->num_rows > 0) {
          ...
          echo "<script>document.getElementById('kid').innerHTML = " . $countKid . ";</script>";
          echo "<script>document.getElementById('adult').innerHTML = " . $countAdult . ";</script>";
          echo "<script>document.getElementById('senior').innerHTML = " . $countSenior . ";</script>";
        } else {
